    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        if default_feature:
            ...
            image_edited = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this object in left three-quarters view and make sure it is fully visible in space. Keep object colors and shape and texture. Keep all objects of background around central object. Sharpen image details. Turn color of background to black color contrasting with an object.",
            )
            # 2. Remove background
            ...
            image_edited_2 = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this object in right two-quarters view and make sure it is fully visible in space. Keep object colors and shape and texture. Keep all objects of background around central object. Sharpen image details. Turn color of background to black color contrasting with an object.",
            )
            ...
            image_edited_3 = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this object in back three-quarters view and make sure it is fully visible in space. Keep object colors and shape and texture. Keep all objects of background around central object. Sharpen image details. Turn color of background to black color contrasting with an object.",
            )
